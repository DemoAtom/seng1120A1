...
public:
     ...
     * This will clear all forward history. 
   ...
   void back(int steps);
     ...
     * The current pointer of the bookmark list should be the first element. If no elements are present, prints 'Bookmark list is empty.'
     * 
     * Precondition:   None
     * Postcondition:  The bookmark list pointer is modified to point to the first element in the list.  
     */ 
...
private:
    LinkedList<std::string>* history;     // linked list of history entries
